          ...
          try {
            ...
            if (userDep == "fromFile") {
              ...
              if (bnSplited[0] !== "edigeo") {
                console.error(
                  'le nom du fichier doit être sous la forme "edigeo-DEP....tar.gz" ',
                  fileName
                );
                dep = "00";
              } else {
              ...
              if (!depFeatures) {
                depFeatures = JSON.parse(
                  fs.readFileSync(
                    path.join(__dirname, "dep", `dep2019.geojson`),
                    "utf8"
                  )
                ).features;
            ...
            const commune_id =
              data.geojsons.COMMUNE_id.features[0].properties.IDU_id;
            const section_id =
              data.geojsons.SECTION_id.features[0].properties.IDU_id;
